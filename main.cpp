...
int main(int argc, char * argv[])
{
	...
	BitmapRawConverter outputFileSerialPrewitt("data/SP_color.bmp");
	BitmapRawConverter outputFileParallelPrewitt("data/PP_color.bmp");
	BitmapRawConverter outputFileSerialEdge("data/SE_color.bmp");
	BitmapRawConverter outputFileParallelEdge("data/PE_color.bmp");
